...
END:VCALENDAR`;
  ...
  return (
    <footer
      ref={ref}
      className="relative py-14 px-6 md:px-16 bg-gradient-to-t
                 from-[#3d2207] via-[#5d2e0a] to-[#3d2207]
                 border-t-4 border-[#daa520]/40 text-white"
    >
      {/* Soft gold glow */}
      <div className="absolute inset-0 -z-10">
        <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-[#daa520]/20 blur-3xl rounded-full" />
        <div className="absolute bottom-1/4 right-1/4 w-72 h-72 bg-[#fbbf24]/10 blur-[160px] rounded-full" />
      </div>
      ...
      >
        {/* Names */}
        <h2 className="text-3xl md:text-4xl font-font font-black
        ...
        <div className="grid md:grid-cols-3 gap-6 text-sm mb-10">
          ...
          <div>
            ...
            <p
              onClick={copyEmail}
              className="cursor-pointer underline decoration-[#daa520]/60"
            >
              {email}
              {copied && (
                <span className="ml-2 text-xs bg-[#daa520] text-black px-2 py-0.5 rounded-full">
                  Copied
                </span>
              )}
            </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <button
            ...
            className="px-8 py-3 rounded-full border border-[#e2725b]/60
                       text-[#e2725b] hover:bg-[#e2725b]/20 transition"
          >
            📱 WhatsApp
          </button>
          ...
          <button
            ...
            className="px-8 py-3 rounded-full border border-[#daa520]/60
                       text-[#daa520] hover:bg-[#daa520]/20 transition"
          >
            📅 Add to Calendar
          </button>
        </div>
        ...
        <p className="text-xs text-white/70 font-serif italic">
          Designed with ❤️ for our special day <br />
